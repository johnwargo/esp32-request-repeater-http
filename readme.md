...
A simple Arduino sketch for ESP32 that makes an HTTP requested to a supplied host then puts the device to sleep for a specified period before doing it again.
